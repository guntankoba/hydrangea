...
function mixColorWithWhite(color, weight = 0.35) {
    ...
    const mix = (channel) => Math.round(channel * clampWeight + 255 * (1 - clampWeight));
...
function renderChoiceWithAccent(choice, accents) {
    ...
    const highlightBackground = mixColorWithWhite(accent.accentColor, 0.35) || accent.accentShadow || accent.accentColor;
